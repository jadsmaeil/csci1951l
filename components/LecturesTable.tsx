            ...
            <tbody>
                {Lectures.map((lecture) => (
                    <tr key={lecture.topic} className="lecture-table-row">
                        ...
                        <td>
                            {lecture.slidesLink ? (
                                <a className="lecture-link inline-flex items-center" target="_blank" href={lecture.slidesLink}>
                                    Slides
                                    <svg
                        ...
                        <td>
                            {lecture.recordingLink ? (
                                <a className="lecture-link inline-flex items-center" target="_blank" href={lecture.recordingLink}>
                                    Recording
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-4 w-4 ml-2 text-teal-400"
